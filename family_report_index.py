...
class family_report_index_class(object):
...
def add_family_report_index(key, surname, forename, birth_year,
                            family_number_where_spouse, family_number_where_child):
    family_report_index.append(family_report_index_class(key, surname, forename, birth_year,
                                family_number_where_spouse, family_number_where_child))
